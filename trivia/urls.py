...
urlpatterns = [
    ...
    path('games/<int:game>/answer/<int:round>/<int:question>/', views.response_view, name='new_answer'),
    ...
    path('games/double/<int:game>/', views.doubleround_view, name='double_round'),
