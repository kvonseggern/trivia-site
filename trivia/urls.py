...
urlpatterns = [
    ...
    path('games/<int:game>/answer/<int:round>/<int:question>/', views.QuestionResponseCreate.as_view(), name='new_answer'),
    path('games/answer/update/<int:pk>/', views.QuestionResponseUpdate.as_view(), name='update_answer'),
